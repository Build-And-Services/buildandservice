  ...
  return (
    <React.Fragment>
      ...
      <main className=''>
        ...
        <section className='bg-[#c8e7df] w-full rounded-sm mb-20 sm:max-w-6xl mx-auto py-10'>
        ...
        <div className='mt-[180px]'>
          ...
          <Marquee pauseOnHover direction='right' className='mt-[30px] py-[40px]'>
            <div className='items-center mr-20 w-[350px]'>
              <a href='#' className='p-[20px] w-full bg-white shadow-md border-4 border-white hover:text-blue-500 hover:border-solid hover:border-4 hover:border-green-500  rounded-lg inline-flex items-center justify-center '>
            ...
            <div className='items-center mr-20 w-[350px]'>
              <a href='#' className='p-[20px] w-full bg-white shadow-md border-4 border-white over:text-blue-500 hover:border-solid hover:border-4 hover:border-green-500  rounded-lg inline-flex items-center justify-center '>
