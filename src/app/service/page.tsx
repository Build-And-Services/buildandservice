        ...
        <div className='grid items-center gap-12 lg:grid-cols-2 mx-8 md:mx-auto'>
          <div className='service-content' data-aos='fade-right'>
            ...
            <h2 className='text-4xl md:text-6xl font-bold text-green-600'>
              Semua Service
              <br />
              <span className='font-semibold text-neutral-900'>tersedia disini</span>
            </h2>
            <Link href='/formulir' className='relative inline-block px-3 py-1 md:px-6 md:py-3 font-medium group my-6'>
              ...
              <span className='relative text-green-600 text-sm md:text-lg group-hover:text-white'>Request Now</span>
            </Link>
          </div>
          <div className='service-image' data-aos='zoom-in'>
            <Image src={bannerService} alt='banner-service' className='rounded-xl shadow-lg' />
          </div>
        </div>
      </section>
      <main className='w-full py-10'>
        <div data-aos='fade-up' className='mb-20'>
          <h1 className='text-center text-xl lg:text-3xl w-full lg:w-7/12 mx-auto text-slate-900 font-bold'>Our Services</h1>
        </div>
