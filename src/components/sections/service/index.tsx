...
export default function SectionService({ image, title, description }: SectionServiceProps) {
  return (
    <section className='max-w-7xl mx-auto mb-36'>
      <div className='grid items-center gap-12 lg:grid-cols-10 mx-8 md:mx-auto'>
        <div className='service-image col-span-4' data-aos='zoom-in'>
          <Image src={image} alt='service-webdev' priority className='rounded-tl-3xl rounded-br-3xl shadow-lg' width={500} height={500} />
        </div>
