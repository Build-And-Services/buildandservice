...
export default function FaqAccordion({ title, description }: FaqAccordionProps) {
  ...
  return (
    <div className='border px-5 py-3 rounded-md bg-white space-y-8 transition-all duration-500 cursor-pointer ' data-aos='fade-up' data-aos-duration='1500' onClick={() => openTab()}>
      {/* question */}
