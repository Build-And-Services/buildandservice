          ...
          <section className='flex flex-col gap-9'>
            ...
            <div className=''>
              <div className='flex flex-col gap-5.5 p-6.5'>
                <form action=''>
                  <InputText label='Nama' name='nama' placholder='Nama' type='text' />
                  <InputText label='No Handphone' name='handphone' placholder='08...' type='text' />
                  <InputText label='Judul Project' name='project' placholder='ex: Company Profile' type='text' />
                  <InputSelect label='Type Project' name='projects-type' placholder='' data={dataSelect} />
                  <InputText label='Range Min Harga' name='minfee' placholder='' type='number' />
                  <InputText label='Range Max Harga' name='maxfee' placholder='' type='number' />
                  <InputTextArea name='description' label='Desciption Project' placholder='Website untuk company profile' value='' />
                  <InputFile label='Upload Sistem Requirement' name='sr' type='file' />
                  <button
                    type='submit'
